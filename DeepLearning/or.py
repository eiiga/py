...
# cainer.serializers.load_npz('result/out.model', model)
...
trainer.extend(extensions.Evaluator(test_iter, model)) # エボック数の表示
trainer.extend(extensions.PrintReport(['epoch', 'main/loss', \
'validation/main/loss', 'main/accuracy', 'elapased_time'])) #計算状態の表示
# trainer.extend(extensions.dump_graph('main/loss')) # ニューラルネットワークの構造
# trainer.extend(extensions.PlotReport(['main/loss', 'validation/main/loss'], \
# 'epoch', file_name='loss.png')) # 誤差のグラフ
